  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-between w-[67%] p-4">
        <div>
          <h3 className=" font-bold line-clamp-2 text-left hover:underline"><a href={product.product_url} target="_blank" rel="noopener noreferrer">{product.title}</a></h3>
          <p className="text-gray-500 dark:text-gray-400 flex flex-row my-2">
          Price: <FaRupeeSign className='my-auto' /> {product.price}
          </p>
        </div>
        {/* <div className="text-sm text-gray-500 dark:text-gray-400">Footer text</div> */}
      </div>
    </Card>
    </div>
  )
